            ...
            <TabGroup as="div">
              ...
              <TabPanels as="template">
                ...
                <TabPanel class="pt-10">
                  ...
                  <div class="text-sm text-gray-500 [&_h4]:mt-5 [&_h4]:font-medium [&_h4]:text-gray-900 [&_li]:pl-2 [&_li::marker]:text-gray-300 [&_p]:my-2 [&_p]:text-sm/6 [&_ul]:my-4 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5 [&_ul]:text-sm/6 [&>:first-child]:mt-0" v-html="license.content"></div>
                </TabPanel>
              </TabPanels>
            </TabGroup>
          </div>
