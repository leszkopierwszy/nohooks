<template>
    <div class="bg-white">
      <div>
        ...
        <main class="mx-auto lg:max-w-8xl px-4 sm:px-6">
          <!-- X button -->
          <div class="pb-3">
          ...
          <div class="flex items-baseline justify-between border-b border-gray-200 pb-6">        
            <h1 class="text-4xl font-bold tracking-tight text-gray-900">{{ capitalizeWord(name) }}</h1>

            <div class="flex items-center">
              <Menu as="div" class="relative inline-block text-left">
                <button class="group inline-flex justify-center text-sm pr-3 font-medium text-gray-700 hover:text-gray-900">
                  Filter
                </button>
